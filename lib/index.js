...
function IframeVideo(props) {
  return React.createElement(Iframe, _extends$1({}, props, { src: getSrc(props.item), full: false,
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        !!metrics ? items.map(function (item, index) {
          return React.createElement(LightboxItem, _extends$1({}, props, { item: item, metrics: metrics,
            key: item.index }));
        }, this) : null
      );
    }
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        props.carousel ? visible(props).map(function (item, index) {
          return React.createElement(Item, _extends$1({}, props, { item: item.item, key: item.item.index,
            left: item.left }));
        }, this) : null
      );
    }
